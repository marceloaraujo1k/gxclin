    ...
    <div id="wrapper">
      ...
      <!-- INCLUSÃO DO ARQUIVO MENU -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Filial</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
					    ...
					    <button class="btn btn-primary" data-toggle="modal" data-target="#modalUsuario">Inserir Filial</button>
						</div>
						 <div class="col-lg-10">
						</div>
						  ...
						  <div class="panel-body">
							<table width="100%" class="table table-striped table-bordered table-hover table-responsive" id="listar-filial">
                                <thead>
                                    <tr>
...
<!--  IMPORT PARA UTILIZACAO DOS BOTES DE IMPRIMIR, EXPORTAR EM CSV, PDF, EXCEL -->
    ...
    <script>
   	...
   	$(document).ready(function() {
			var table = $('#listar-filial').DataTable({
				"processing": true,
				"serverSide": true,
				"ajax": {
					"url": "proc_empresa.php",
					"type": "POST"
				}
				});
			});
	...
	<script>
		$(document).on('click','#btnExcluir',function(e){
            e.preventDefault();
		var id = $(this).data('id');
		 confirm("Excluir FILIAL ? " +id);
		location.assign("deleteEmpresa.php?id="+id);
		});
	</script>	
	...
	<script>
		...
		xmlhttp.open("GET", "operacoes_empresa.php?id="+id, true);
		xmlhttp.send();
		$("#modalUsuario").modal();
		});
